...
**Self-taught AI Engineer & Researcher**
...
💼 **LinkedIn:** [mahmoudmohajer](https://www.linkedin.com/in/mahmoudmohajer/)  
🐦 **Twitter/X:** [@Mah_Mohajer](https://x.com/Mah_Mohajer)
...
- **[CUDA Matrix Optimizations](https://github.com/MahmoudMohajer)**: High-performance General Matrix Multiply (GEMM) kernels tiled in shared memory to profile latency limits.
- **[Toy Transformer from Scratch](https://github.com/MahmoudMohajer)**: Educational GPT-style transformer decoder written in pure NumPy to study backpropagation gradients.
- **[Decentralized Compute Discovery](https://github.com/MahmoudMohajer)**: Node discovery prototype using decentralized metadata lookup to map GPU resources over local networks.
